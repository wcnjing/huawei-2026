...
| POST | `/api/house/family` | Place yourself in the family tree with `{family: {role, parentIds, partnerId, childIds}}`; ids must be other members; rejects cycles, a third parent, or a partner who is also a parent/child |
